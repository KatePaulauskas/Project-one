...
The structure of the Aerial Photography project's website was initially developed using Balsamiq Studios software, through which a mockup wireframe was created for the current project

- Home page

![Home page wireframe](assets/media/home-page-wireframe.png)

- Projects page

![Projects page wireframe](assets/media/projects-page-wireframe.png)

- Contact page

![Contact page wireframe](assets/media/contact-page-wireframe.png)
